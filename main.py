...
class Window(QWidget):
    ...
    def _connect_to_db(self):
        self.conn = psycopg2.connect(database = "s_ui",
                                     user = "postgres",
                                     password = "123456",
                                     host = "localhost",
                                     port = "5432")
    ...
    def _update_monday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM shedule WHERE day = 'monday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_tuesday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM shedule WHERE day = 'tuesday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_wednesday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM shedule WHERE day = 'wednesday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_thursday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM shedule WHERE day = 'thursday'")
        records = list(self.cursor.fetchall())
    ...
    def _update_friday_table(self):
        self.cursor.execute("SELECT id, subject, room_numb, start_time FROM shedule WHERE day = 'friday'")
        records = list(self.cursor.fetchall())
